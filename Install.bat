...
ECHO.
ECHO Building and installing SurfaceXWing.
PAUSE
ECHO.
...
:SurfaceXWing
ECHO Building SurfaceXWing...
%MsBuildPath% SurfaceXWing\SurfaceXWing.csproj %MSBuildParameters%
IF ERRORLEVEL 1 goto SurfaceXWingError
ECHO Generating SurfaceXWing XML...
CreateShellXML.vbs SurfaceXWing\InstalledAppInfo\SurfaceXWing.xml "%CD%" SurfaceXWing %ExeDirPath%
ECHO Installing SurfaceXWing to Surface Shell...
ECHO.
goto COMPLETE

:SurfaceXWingError
SET BuildErrors=true
ECHO Error building SurfaceXWing. Please build in Visual Studio and rerun this batch file.
ECHO.
